## Summary
RuneCode provides offline workspace execution roles with explicit capability boundaries for read, edit, and test operations.
...
## Impact
Keeps role-level execution boundaries explicit and reviewable as a standalone feature.
