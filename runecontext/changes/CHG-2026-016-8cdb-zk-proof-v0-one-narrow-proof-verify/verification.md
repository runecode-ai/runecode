...
- Confirm canonical references now point at RuneContext project, spec, and change paths rather than `agent-os/` planning paths.
...
- Confirm the change still matches its v0.1.0-beta.1 roadmap bucket and title after migration.
