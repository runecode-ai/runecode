...
- `standards/javascript/runner-typescript-as-lint.md`

## Resolution Notes
Split from `CHG-2026-012-f1ef-workflow-runner-workspace-roles-deterministic-gates-v0` and keeps the same runner and trust-boundary standards for untrusted scheduler behavior.
