...
## Problem
The legacy macOS Virtualization Polish plan still lives under `agent-os/specs/2026-03-08-1039-macos-virtualization-polish/`, so the roadmap and related planning references do not yet point at a canonical RuneContext change record.
