...
## Problem
The legacy Windows MicroVM Runtime Support plan still lives under `agent-os/specs/2026-03-08-1039-windows-microvm-runtime/`, so the roadmap and related planning references do not yet point at a canonical RuneContext change record.
