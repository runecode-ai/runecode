...
## Problem
The legacy External Audit Anchoring v0 plan still lives under `agent-os/specs/2026-03-13-1603-external-audit-anchoring-v0/`, so the roadmap and related planning references do not yet point at a canonical RuneContext change record.
