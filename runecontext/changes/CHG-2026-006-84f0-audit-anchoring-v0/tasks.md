...
- [ ] Implement an MVP anchoring mode that requires explicit user presence to mint a receipt:
  - sign the segment root commitment using the per-machine signing key with a user-presence gate (see `runecontext/changes/CHG-2026-005-cfd0-crypto-key-management-v0/`)
