...
## Problem
The legacy Audit Log v0 + Verify plan still lives under `agent-os/specs/2026-03-08-1039-audit-log-verify-v0/`, so the roadmap and related planning references do not yet point at a canonical RuneContext change record.
