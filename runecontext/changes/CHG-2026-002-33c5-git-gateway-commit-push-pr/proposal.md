...
## Problem
The legacy Git Gateway (Commit/Push/PR) plan still lives under `agent-os/specs/2026-03-08-1039-git-gateway/`, so the roadmap and related planning references do not yet point at a canonical RuneContext change record.
