...
## Problem
The legacy Auth Gateway Role v0 plan still lives under `agent-os/specs/2026-03-12-1030-auth-gateway-role-v0/`, so the roadmap and related planning references do not yet point at a canonical RuneContext change record.
