...
## Problem
The legacy Broker + Local API v0 plan still lives under `agent-os/specs/2026-03-08-1039-broker-local-api-v0/`, so the roadmap and related planning references do not yet point at a canonical RuneContext change record.
...
## Impact
Keeps Broker + Local API v0 reviewable as a RuneContext-native change and removes the need for a second semantics rewrite later.
